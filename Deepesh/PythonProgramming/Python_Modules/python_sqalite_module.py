...
def create_data_base(db_name='student_database.db'):
...
select_data_query2 = """select * from student where phone='4068061101'"""
...
select_data_query2 = """select name from student where phone='4068061101'"""
data = list(run_select_query(select_data_query2))
print(data[0][0])
assert data[0][0] == 'uburton'
