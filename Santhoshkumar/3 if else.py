...
if round1 == "pass":
    ...
    if round2 == "pass":
        print("Second round is cleared")000000
        if round3 == "pass":
...
age=19
if age > 18:
    print("Ready for vote",age)
else:
    print("Age is less Not ready for vote",age)
...
unit=int(input("enter the unit for the charges:"))
unit1 = 100
unit2 = 200
unit3 = 300

if unit1 > unit2:
    print("unit is less than 100: ",unit1*15)
elif unit2 < unit1:
    print("unit is high 100: ",unit2*20)
elif unit3 > unit2:
    print("unit is high 200:",unit3*25)
else:
    print("unit is not  ")
